...
| 应用       | 产物路径             | 说明                |
| ---------- | -------------------- | ------------------- |
| 主应用     | public/apps/root     | 包含 remoteEntry.js |
| Account    | public/apps/account  | 独立站点            |
| Designer   | public/apps/designer | 包含 remoteEntry.js |
| Renderer   | public/apps/renderer | 包含 remoteEntry.js |
| Admin      | public/apps/admin    | 包含 remoteEntry.js |
| @cwj/auth  | npm 包               | 发布到私有 npm 仓库 |
| @cwj/ui-\* | npm 包               | 发布到私有 npm 仓库 |
| @cwj/tools | npm 包               | 发布到私有 npm 仓库 |
