...
fix(designer): 修复拖拽组件位置错误
docs(readme): 更新安装说明
style(user): 格式化用户管理代码
...
git commit -m "feat(auth): 集成登录 API"

# ❌ 避免: 大而全的提交
git commit -m "feat(auth): 完成整个登录功能"

# ✅ 推荐: 清晰的提交信息
git commit -m "fix(designer): 修复拖拽时组件位置计算错误"
