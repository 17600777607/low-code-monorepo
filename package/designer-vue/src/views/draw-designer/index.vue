...
import { countNodes, getDepth, findAllNodes, isElementNode } from '@designer-vue/ast/index'
...
import DrawLeft from '@designer-vue/views/draw-designer/draw-left/index.vue'
import DrawCenter from '@designer-vue/views/draw-designer/draw-center/index.vue'
import DrawRight from '@designer-vue/views/draw-designer/draw-right/index.vue'
...
watch(
  ...
  newComponents => {
    ...
    // 构建完整的 AST (包含所有扩展属性)
    const ast: import('@designer-vue/ast/types').RootNode = {
      type: NodeType.ROOT,
